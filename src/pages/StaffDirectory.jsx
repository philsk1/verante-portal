...
function StaffDetailPanel({ draft, toggleActive, closeProfile, previewReadOnly, editingSkills, setEditingSkills, setDraft, catalogueItems, onNavigate, removeStaff, saveProfile, saving, saved }) {
  const inp = (style = {}) => ({
  ...
  return (
    <div data-help="Your team directory — full profiles, contact details, skills and private notes. Click any card to view or edit." data-help-score={staff.length === 0 ? 20 : 95}>
      ...
      <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'flex-start' }}>
        ...
        <StaffDetailPanel draft={draft} toggleActive={toggleActive} closeProfile={closeProfile} previewReadOnly={previewReadOnly} editingSkills={editingSkills} setEditingSkills={setEditingSkills} setDraft={setDraft} catalogueItems={catalogueItems} onNavigate={onNavigate} removeStaff={removeStaff} saveProfile={saveProfile} saving={saving} saved={saved} />
      </div>
    </div>
  )
}
