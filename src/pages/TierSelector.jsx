...
const TIERS = [
  {
    ...
    minutes: 'Pay as you go · 35p/min',
    features: ['AI call handling', 'Lead capture', 'Partner referrals', 'Standard voice', 'Full portal'],
    color: '#666',
    bg: '#f5f5f5',
    border: '#ddd',
  },
  {
    ...
    price: '£29/mo',
    concurrent: '1 concurrent call',
    minutes: '120 Premium mins/month',
    features: ['Premium voice included', 'Lead capture', 'Partner referrals', 'Dashboard'],
    color: '#5e3b87',
    bg: '#f3f1f7',
    border: 'rgba(94,59,135,0.2)',
  },
  {
    id: 'standard',
    name: 'Standard',
    price: '£49/mo',
    concurrent: '1 concurrent call',
    minutes: '250 Premium mins/month',
  ...
  },
  {
    ...
    minutes: '450 Premium mins/month',
  ...
  },
  {
    ...
    minutes: '1,000 Premium mins/month',
